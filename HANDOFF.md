...
revision: working tree on main after 9f4f08e
  (new: Formal/R3DecoderFrequencyBridge.lean; extended: Formal/AxiomAudit.lean)
toolchain: leanprover/lean4:v4.32.1
dependency manifest: committed lake-manifest.json; mathlib per lake-manifest.json
target scope: lake build Formal.R3DecoderFrequencyBridge / Formal.AxiomAudit —
  pass, no new warnings
full scope: lake build (Formal.+ default target) — pass (8759 jobs; remaining warnings
...
axiom scope: Formal.AxiomAudit — pass; all seven new audited declarations
  (integrable_r3DecodedFrequency, integrable_weighted_r3DecodedFrequency,
   r3DecodedFrequency_ae_coeFn_fourier, r3Decoded3PhysicalVelocity_mem_solenoidal,
   r3DecodedFrequency_incompressible, r3L2ToTempered_r3Decoded3PhysicalVelocity,
   r3DecodedFrequency_incompressible_leray)
...
all their audited declarations standard-axioms-only.
