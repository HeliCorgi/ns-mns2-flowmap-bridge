...
revision: working tree on main after faa0f96
  (new: Formal/R3ConvectionSourceIdentification.lean; extended: Formal/AxiomAudit.lean)
toolchain: leanprover/lean4:v4.32.1
dependency manifest: committed lake-manifest.json; mathlib per lake-manifest.json
target scope: lake build Formal.R3ConvectionSourceIdentification / Formal.AxiomAudit —
  pass, no new warnings (file itself: zero errors, zero warnings)
full scope: lake build (Formal.+ default target) — pass (8762 jobs; remaining warnings
...
axiom scope: Formal.AxiomAudit — pass; all seven new audited declarations
  (integral_norm_r3DecodedFrequency_le, r3PhysicalRepresentative_ae_fourierInv,
   r3DecodedDerivativeL2Operator_ae_deriv, r3DecodedConvectionL2_schwartz,
   r3H2ToL2Operator_r3ConvectionH3ToH2, r3H2ToL2Operator_r3ProjectedConvectionH3ToH2,
...
(faa0f96) — all their audited declarations standard-axioms-only.
