...
revision: working tree on main after ec3517b
  (extended: Formal/R3ConvectionSourceIdentification.lean, Formal/AxiomAudit.lean)
...
axiom scope: Formal.AxiomAudit — pass; all nine audited 2b-i declarations
  (integral_norm_r3DecodedFrequency_le, r3PhysicalRepresentative_ae_fourierInv,
   ...
   exists_r3DecodedConvectionL2_ne_zero, exists_r3ConvectionH3ToH2_ne_zero)
