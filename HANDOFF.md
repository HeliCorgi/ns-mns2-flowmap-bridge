...
revision: working tree on main after 9acae9a
  (new: Formal/R3CoordinateIncompressibility.lean; extended: Formal/AxiomAudit.lean)
toolchain: leanprover/lean4:v4.32.1
dependency manifest: committed lake-manifest.json; mathlib per lake-manifest.json
target scope: lake build Formal.R3CoordinateIncompressibility / Formal.AxiomAudit —
  pass, no new warnings
full scope: lake build (Formal.+ default target) — pass (8757 jobs; the single warning
  is a cache replay of the pre-existing Formal/R3YoungL2L1Bochner simpa lint)
source scan: pinned sorry/admit/axiom/opaque scan over changed files — clean
axiom scope: Formal.AxiomAudit — pass; both new audited declarations
  (r3TemperedDivergence_apply, r3TemperedDivergence_eq_zero_of_mem_solenoidal)
