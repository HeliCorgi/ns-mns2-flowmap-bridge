...
revision: working tree on main after 778eaa2
  (new: Formal/R3InversionConsistency.lean; extended: Formal/AxiomAudit.lean;
   doc-updated: Formal/R3DecoderFrequencyBridge.lean module docstring)
toolchain: leanprover/lean4:v4.32.1
dependency manifest: committed lake-manifest.json; mathlib per lake-manifest.json
target scope: lake build Formal.R3InversionConsistency / Formal.AxiomAudit —
  pass, no new warnings
full scope: lake build (Formal.+ default target) — pass (8760 jobs; remaining warnings
...
axiom scope: Formal.AxiomAudit — pass; all four new audited declarations
  (integral_smul_r3PhysicalRepresentative, integral_smul_r3Decoded3PhysicalVelocity,
   r3PhysicalRepresentative_ae_r3Decoded3PhysicalVelocity,
   r3DecodedFrequency_incompressible_ae_decoder)
...
edge 3a at 8759 jobs (778eaa2) — all their audited declarations
