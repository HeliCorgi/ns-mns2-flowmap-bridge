...
> `research/fdt-lh-decision`. For `C_j(a,b)=P[Delta_j,a·grad]b`, a real
> divergence-free Schwartz packet counterfamily gives a subcritical target high block
> but arbitrarily large normalized LH contribution while ordinary energy and the
...
> Record: `docs/gates/FDT_LH_DYN_AFFINE_DECISION_2026-09-06.md` on PR #87. The exact
...
> Record: `docs/gates/FDT_MAT_STRUCT_DECISION_2026-09-06.md` on PR #87.
>
...
- `main` at start of session 36: `2fa19df787201a3f306043fd632f569fc245cf4c`
  (merged PR #86).
...
- Session-36 material-structure record first commit:
  `5be7bdb23d41d13197a2d2a08b9355bcc8836c48`.
- No Lean/runtime source changed in sessions 34–36; `FORMAL_SCOPE.md` and `STATUS.md`
  remain intentionally unchanged.
- PR #87 run #263 (`33950506980`), job `101264255550`, completed successfully before
  session-35/36 final doc pushes. A later docs-only status run may be in progress.
