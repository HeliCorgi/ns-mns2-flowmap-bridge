...
revision: working tree on main after 0403c06
  (new: Formal/R3HelmholtzPressure.lean; extended: Formal/AxiomAudit.lean)
toolchain: leanprover/lean4:v4.32.1
dependency manifest: committed lake-manifest.json; mathlib per lake-manifest.json
target scope: lake build Formal.R3HelmholtzPressure / Formal.AxiomAudit —
  pass, no new warnings
full scope: lake build (Formal.+ default target) — pass (8761 jobs; remaining warnings
...
axiom scope: Formal.AxiomAudit — pass; all five new audited declarations
  (integrable_r3PressureFrequencyLow, memLp_two_r3PressureFrequencyHigh,
   fourier_r3LerayComplementL2_ae, r3HelmholtzPressure_gradient,
   exists_r3LerayComplementL2_ne_zero)
...
edge 3a at 8759 jobs (778eaa2); edge 3b at 8760 jobs (0403c06) — all their audited
